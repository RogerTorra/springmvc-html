...
/**
 * Created by hellfish90 on 10/01/15.
 */
 ...
 */
public class ExampleXMLConnectionTest {
    private static final Logger  log = Logger.getLogger(ExampleXMLConnectionTest.class.getName());
    ...
    ExampleXMLConnectionTest(String xquery, URL url)
    ...
    public static void main(String[] args) {
        try {
            ExampleXMLConnectionTest xQueryHelper = new ExampleXMLConnectionTest(albumsXQ, new URL(apiURL));
